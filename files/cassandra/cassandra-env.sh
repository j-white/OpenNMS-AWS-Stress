...
# Jolokia JVM Agent (to use it with Hawtio);
JVM_OPTS="$JVM_OPTS -javaagent:/etc/cassandra/jolokia-jvm-agent.jar=host={{ ec2_private_ip_address }}"
...
JVM_OPTS="$JVM_OPTS -Djava.rmi.server.hostname={{ ec2_private_ip_address }}"
#
# see
